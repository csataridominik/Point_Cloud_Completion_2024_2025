...
from MLPMixer import MLPMixer,MLPMixer_decoder
from PointAttn_BigBird import PCT_encoder
...
class Model(nn.Module):
    def __init__(self, args):
        ...
        self.refine = MLPMixer_decoder(ratio=step1,pcd_size=512,refine_step=1)
        self.refine1 = MLPMixer_decoder(ratio=step2,pcd_size=2048,refine_step=2)
